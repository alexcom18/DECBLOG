    ...
    <div class="card">
        <div class="card-body">
            <?php echo Form::open(['route' => 'admin.posts.store', 'autocomplete' => 'off', 'files' => true]); ?>
                ...
                <?php echo Form::submit('Crear publicacion', ['class' => 'btn btn-primary']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DECBLOG\resources\views/admin/posts/create.blade.php ENDPATH**/ ?>